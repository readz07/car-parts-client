        ...
        <div className='my-12'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 place-items-center gap-2 my-12'>
                <div class="card w-3/4 bg-base-100 shadow-xl">
                    <div class="card-body">
                        <h2 class="card-title text-primary">Question 1: How will you improve the performance of a React Application?</h2>
                ...
                <div class="card w-3/4 bg-base-100 shadow-xl">
                    <div class="card-body">
                        <h2 class="card-title text-primary">Question 2: What are the different ways to manage a state in a React application?</h2>
                ...
                <div class="card w-3/4 bg-base-100 shadow-xl">
                    <div class="card-body">
                        <h2 class="card-title text-primary">Question 3: How does prototypical inheritance work?</h2>
                ...
                <div class="card w-3/4 bg-base-100 shadow-xl">
                    <div class="card-body">
                        <h2 class="card-title text-primary">Question 4: You have an array of products. Each product has a name, price, description, etc. How will you implement a search to find products by name?</h2>
                ...
                <div class="card w-3/4 bg-base-100 shadow-xl">
                    <div class="card-body">
                        <h2 class="card-title text-primary">Question 5: What is a unit test? Why should write unit tests?</h2>
